...
import { ConceptSelect, ModelSelect, FeatureInput } from "./sidebar"
...
const seleConcepts = computed<
  Record<CoreTokenType, Record<string, number[]>>
>(() => Concepts[model.value])
