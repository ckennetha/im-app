...
const url = computed<string>(() =>
  `https://api.github.com/repos/ckennetha/im-data/contents/${props.model}/samples/${props.feature}.json?ref=ext-descs`
)
    ...
    <div class="flex flex-1 flex-wrap items-center gap-2">
      ...
      <TooltipProvider disableClosingTrigger>
        <Tooltip v-model:open="open">
          ...
          <TooltipContent :collisionPadding="{ left: 20 }"
            class="bg-foreground text-background max-w-56 sm:max-w-74"
          >
